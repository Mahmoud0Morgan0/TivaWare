...
typedef enum
{
    TIMER0,TIMER1,TIMER2,TIMER3,TIMER4,TIMER5,TIMER0_WIDE,TIMER1_WIDE,TIMER2_WIDE,TIMER3_WIDE,TIMER4_WIDE,TIMER5_WIDE
}sTimers_t;

typedef enum
{
    UART0_MOD,UART1_MOD,UART2_MOD,UART3_MOD,UART4_MOD,UART5_MOD,UART6_MOD,UART7_MOD
}sUART_t;
typedef enum
{
    CAN0_MOD,CAN1_MOD
...
typedef enum
{
    MAIN_OSC , INTERNAL_16M , INTERNAL_30K
}sClockSRC_t;

typedef enum
{
    c1MHZ, c2MHZ,c4MHZ,c8MHZ,c16MHZ,c20MHZ,c40MHZ,c80MHZ
}sClockValue_t;
