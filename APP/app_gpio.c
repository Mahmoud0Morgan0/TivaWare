...
gGPIOError_t initPin(gGPIOObj_t *obj){
   ...
   /* gpioPinInterruptConfig(obj->base,obj->pin_num,obj->interruptObj.interruptSense);
    NVICInterruptEnable(obj->interruptObj.interruptIndex,obj->interruptObj.priority,
    		            obj->interruptObj.pendingFlag);*/
	return state;
}
...
gGPIOError_t initPort(gGPIOObj_t *obj,uint8 val){
   ...
   /* if(obj->interruptObj.enableInterrupt == TRUE){
    	gpioPinInterruptConfig(obj->base,obj->pin_num,obj->interruptObj.interruptSense);
    	NVICInterruptEnable(obj->interruptObj.interruptIndex,obj->interruptObj.priority,
    	    		        obj->interruptObj.pendingFlag);
    }*/
